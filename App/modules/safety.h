...
#define SAFETY_FAILSAFE_CRASH   0x0008U
#define SAFETY_ARM_BLOCK_RC       0x0001U
#define SAFETY_ARM_BLOCK_IMU      0x0002U
#define SAFETY_ARM_BLOCK_BATTERY  0x0004U
#define SAFETY_ARM_BLOCK_THROTTLE 0x0008U
#define SAFETY_ARM_BLOCK_LEVEL    0x0010U
#define SAFETY_ARM_BLOCK_LATCH    0x0020U
#define SAFETY_ARM_BLOCK_CRASH    0x0040U
#define SAFETY_DISARM_ARM_LOST  0x0100U
#define SAFETY_DISARM_CRASH     0x0200U
