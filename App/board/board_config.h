...
#define BOARD_MAX_ANGLE_DEG           22.0f
#define BOARD_MAX_YAW_RATE_DPS        110.0f
#define BOARD_LEVEL_GAIN_DPS_PER_DEG  2.5f
#define BOARD_MAX_LEVEL_RATE_DPS      180.0f
#define BOARD_RC_EXPO_PERCENT         25U
