...
#define BOARD_LEVEL_GAIN_DPS_PER_DEG  3.0f
#define BOARD_MAX_LEVEL_RATE_DPS      220.0f
...
#define BOARD_MOTOR_IDLE_PERMILLE     120U
#define BOARD_MOTOR_IDLE_MAX_PERMILLE 200U
#define BOARD_MOTOR_MAX_PERMILLE      1000U
